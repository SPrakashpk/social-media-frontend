...
export const followUser = (userId) => axios.post(`/users/${userId}/follow?currentUserId=${currentUser.id}`);
...
export const getUserProfile = (userId) => axios.get(`/users/profile-details?id=${userId}&currentUserId=${currentUser.id}`);
